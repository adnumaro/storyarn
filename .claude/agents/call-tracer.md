...
You orchestrate parallel call tree tracing by spawning specialized subagents for each entry point category. Each
subagent gets fresh context for deep, focused analysis.
