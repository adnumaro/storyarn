...
const flowSharedTechnicalPorts = [
  ...
  "^assets/app/shared/composables/(useAssetDecisionUpload|useColumnResize|useLive|useLiveAction|useLiveEvent|useRemotePickerSearch|useUpload|useVerticalResize)\\.ts$",
