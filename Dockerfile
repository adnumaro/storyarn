...
#   - https://hub.docker.com/_/debian/tags?name=trixie-20260824-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: docker.io/hexpm/elixir:1.20.4-erlang-29.0.6-debian-trixie-20260824-slim
#
...
# install build dependencies (includes Node.js for JS asset bundling)
RUN apt-get update \
