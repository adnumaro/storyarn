...
/**
 * Flow-owned expression editor: Builder | Code.
 *
...
import { useFlowCodeEditor } from "../../expression/useFlowCodeEditor";
import {
  serializeCondition,
  serializeAssignments,
} from "../../expression/domain/expression-serializer";
...
import type { ParsedCondition, ParsedAssignment } from "../../expression/language/tree-parser";
...
const { setContent, format } = useFlowCodeEditor(codeEditorRef, {
  mode: toRef(() => mode),
