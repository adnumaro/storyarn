...
import {
  ...
  OPERATOR_LABELS,
  operatorsForType,
} from "../../../../expression/domain/condition-operators";
import type { ConditionOperator } from "../../../../expression/domain/condition-operators";
import { findVariable, groupVariablesBySheet } from "../../../../expression/domain/variables";
import type { Variable } from "../../../../expression/domain/variables";
import type { ConditionRule } from "../types";
import VariableCombobox from "@components/forms/VariableCombobox.vue";
