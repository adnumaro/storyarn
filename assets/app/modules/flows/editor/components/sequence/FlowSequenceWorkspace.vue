...
import FlowSequenceCommentDialog from "./FlowSequenceCommentDialog.vue";
...
<template>
  ...
  >
    <ContextMenu>
      <ContextMenuTrigger
        as-child
        :disabled="!comments?.state.canComment || !!playback || !ownerReady"
      >
        <div class="flex min-h-0 flex-1 flex-col">
          ...
          >
            ...
            <SequenceLocaleControls
              ...
              :localization-status="
                playback ? playback.localizationStatus : stage.localizationStatus
              "
            ...
            <Button
              ...
              :aria-label="
                $t(
                  fullscreen
                    ? 'flows.sequence_stage.exit_fullscreen'
                    : 'flows.sequence_stage.fullscreen',
                )
              "
          ...
          <div v-show="!playback" class="flex min-h-0 flex-1" :data-narrow-panel="narrowPanel">
              ...
              <div class="shrink-0 space-y-2 border-b border-border p-3">
                ...
                >
                  ...
                  {{
                    $t(
                      importing
                        ? "common.assets.uploading"
                        : "flows.sequence_library.upload_images",
                    )
                  }}
                </Button>
            ...
            >
              ...
              <FlowSequenceAudio
                ref="audioPanel"
                v-if="
                  inspectorTab === 'audio' && ownerId != null && data && ownerReady && !playback
                "
                :key="String(ownerId)"
                :owner-id="ownerId"
                :data="data"
              ...
              <template v-if="inspectorTab === 'visual'">
                ...
                <FlowSequenceInspector
                  ...
                  @revert="
                    push('revert_sequence_visual_layer', {
                      layer_key: selectedLayerKey,
                      fields: $event,
                    })
                  "
                />
                ...
                >
                  ...
                  >
                    ...
                    ><Button
                      ...
                      @click="
                        push('restore_sequence_visual_layer', {
                          layer_key: sequenceLayerKey(layer),
                        })
                      "
      ...
      <ContextMenuContent>
        <ContextMenuItem
          id="sequence-comment-context-add"
          @select="live.pushEvent('comments_open', { node_id: ownerId, presentation: 'workspace' })"
        >
          <MessageSquarePlus class="size-4" />{{ $t("flows.comments.add_comment") }}
        </ContextMenuItem>
      </ContextMenuContent>
    </ContextMenu>
  </section>
