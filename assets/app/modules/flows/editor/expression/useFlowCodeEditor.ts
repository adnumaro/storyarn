/**
 * Flow-owned CodeMirror adapter for the Flow expression language.
 *
...
import { storyarnLanguage } from "./language/parser";
import { storyarnEditorTheme, storyarnHighlighting } from "@plugins/expression-editor/theme";
import { variableAutocomplete } from "./language/autocomplete";
import { expressionLinter } from "./language/linter";
import { formatExpression } from "./language/formatter";
import { parseCondition, parseAssignments } from "./language/tree-parser";
import type { ParsedCondition, ParsedAssignment } from "./language/tree-parser";
import type { Variable } from "./domain/variables";

export interface FlowCodeEditorOptions {
...
export interface UseFlowCodeEditorReturn {
...
export function useFlowCodeEditor(
  containerRef: Ref<HTMLElement | null>,
  options: FlowCodeEditorOptions,
): UseFlowCodeEditorReturn {
