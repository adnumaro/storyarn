...
import TableRowActions from "@modules/sheets/components/entities/blocks/fields/table/TableRowActions.vue";
import TableDraggableRow from "@modules/sheets/components/entities/blocks/fields/table/TableDraggableRow.vue";
import { TableColumn, TableRow } from "../../../../../types";
import { ref, useTemplateRef, watch } from "vue";
import { IDragEvent, makeDroppable } from "@vue-dnd-kit/core";
import { useLive } from "../../../../../../../shared/composables/useLive.ts";
import TTextNumberCell from "@modules/sheets/components/entities/blocks/fields/table/tbodyCells/TTextNumberCell.vue";
import TDateCell from "@modules/sheets/components/entities/blocks/fields/table/tbodyCells/TDateCell.vue";
import TMultiSelectCell from "@modules/sheets/components/entities/blocks/fields/table/tbodyCells/TMultiSelectCell.vue";
import TSelectCell from "@modules/sheets/components/entities/blocks/fields/table/tbodyCells/TSelectCell.vue";
import TBooleanCell from "@modules/sheets/components/entities/blocks/fields/table/tbodyCells/TBooleanCell.vue";
import TFormulaCell from "@modules/sheets/components/entities/blocks/fields/table/tbodyCells/TFormulaCell.vue";
  ...
  <tbody ref="tbodyRef">
    ...
    >
      ...
      <td v-for="column in columns" :key="column.id" class="p-0! relative h-1">
        ...
        <TTextNumberCell v-else :row="row" :column="column" :can-edit="canEdit" />
      </td>
    </TableDraggableRow>
