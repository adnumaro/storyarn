...
function buildPicker() {
  ...
  if (window.EyeDropper) {
    ...
    eyeBtn.style.cssText = "display:flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:0.375rem;border:1px solid hsl(var(--border));background:hsl(var(--muted));cursor:pointer;color:hsl(var(--muted-foreground));flex-shrink:0;"
  ...
  hash.textContent = "#"
  hash.style.cssText = "font-family:monospace;font-size:11px;color:hsl(var(--muted-foreground));opacity:0.4;flex-shrink:0;"
  ...
  innerInput.style.cssText = "width:100%;font-family:monospace;font-size:11px;border:1px solid hsl(var(--border));border-radius:0.25rem;padding:3px 6px;background:hsl(var(--muted));color:hsl(var(--foreground));outline:none;"
...
function onPickerChanged(e) {
  ...
  if (containerRef.value?._swatch) containerRef.value._swatch.style.background = hex
}
