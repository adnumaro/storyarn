...
<template>
  ...
  >
    ...
    <!-- Slug line -->
    <div v-if="slugLine" class="text-[11px] text-muted-foreground px-3 py-2 max-w-[200px] border-b border-border/10 break-words">
    ...
    <!-- Description -->
    <div v-if="description" class="text-[11px] text-muted-foreground px-3 py-2 max-w-[200px] border-b border-border/10 break-words">
