    ...
    <section class="mt-8">
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <Progress
            :model-value="lang.final"
            :max="Math.max(lang.total, 1)"
            class="flex-1"
          />
        ...
        <Table>
          <TableHeader>
            <TableRow class="bg-muted/40 hover:bg-muted/40">
              ...
              <TableHead class="font-medium text-xs text-muted-foreground text-right">Lines</TableHead>
              <TableHead class="font-medium text-xs text-muted-foreground text-right">Words</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
