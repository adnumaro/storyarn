...
<template>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 pt-2 pb-8 space-y-6">
    ...
    <div>
      ...
      <p class="text-sm text-muted-foreground">Create scenes to visualize your world</p>
    </div>
    ...
    <div v-if="total === 0 && !stats" class="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p class="text-sm text-muted-foreground">No scenes yet. Create your first scene to get started.</p>
    </div>
