	...
	>
		<div class="mx-auto w-[min(calc(100%-48px),1280px)]">
			<div class="grid items-center gap-10 lg:grid-cols-[1.1fr_0.72fr]">
				<div>
					<div class="mb-4 inline-flex size-11 items-center justify-center rounded-xl bg-primary/10 text-primary">
						<Compass class="size-5" />
					</div>
					<h2 class="text-[clamp(2rem,3vw,3.4rem)] font-bold leading-[0.96] tracking-[-0.06em] text-foreground">
