...
<template>
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mt-8">
      <!-- Empty state -->
      <div v-if="trashedSheets.length === 0" class="flex flex-col items-center justify-center py-16 text-center">
      ...
      <div v-else class="space-y-2">
        ...
        >
          <div class="flex items-center gap-3 min-w-0">
            <div class="flex-shrink-0 size-10 rounded-lg bg-muted-foreground/10 flex items-center justify-center text-sm font-medium">
