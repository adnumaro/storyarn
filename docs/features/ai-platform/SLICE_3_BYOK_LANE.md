...
- **Capabilities model consumed here**: the immutable `capabilities` metadata list shipped with all seven adapters in Slice 0 (see OVERVIEW lane policy §5) gets its first consumers — lane resolution, Slices 4/9/10, and the connect-CTA logic.
