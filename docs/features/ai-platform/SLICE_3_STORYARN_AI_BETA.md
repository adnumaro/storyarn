...
- no public user-facing AI task ships merely to demonstrate infrastructure; an operator-only diagnostic exercises the production provider until Slice 7.2a/8 adds real tools.
