...
Slices 0–5 and existing Localization/Assets/export contracts. Dialogue proposal UX may inspire the audio preview but is not a hard dependency. Context Engine is explicitly not used.
