# Plan 7: Table Toolbar Variants

> **Scope:** Toolbar adjustments for `table` block types (no config popover).
>
...
**File:** `test/storyarn_web/components/block_toolbar_table_test.exs`
