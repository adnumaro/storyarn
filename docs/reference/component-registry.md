...
`select` `separator` `sheet` `slider` `switch` `table` `tabs` `textarea`
...
| `forms/`              | `EditableText.vue`, `ColorPickerPopover.vue`, `ExpressionEditor.vue`, `VariableCombobox.vue`, `BooleanToggle.vue`, `PasswordInput.vue`                                                                                                                                                                                                                                                                                      |
| `forms/fields/`       | `TextField`, `NumberField`, `SelectField`, `ToggleField`, `SliderField`, `EntityCombobox` (barrel `index.ts`)                                                                                                                                                                                                                                                                                                               |
| `forms/assets/`       | `AssetPicker`, `AssetUploadButton`                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `toolbar/`            | `ToolbarBase`, `ToolbarTooltip`, `DockToolButton`; barrel `index.ts` exports `ToolbarColorPicker`, `ToolbarSeparator`, `ToolbarSizePicker`                                                                                                                                                                                                                                                                                  |
...
`SidebarFrame.vue`, `WorkspaceSidebar.vue`, `DashboardContent.vue`,
...
new workspace, templates) starts with `PageContainer` in its own Vue page, as the
...
| `layout` | `stack` (default), `aside`    | sections one under another, or a sticky 360 px `#aside` slot column |
