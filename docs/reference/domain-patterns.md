...
| Versioning       | `Storyarn.Versioning`       | `EntityVersion`, `VersionCrud`, `SnapshotBuilder`, `SnapshotStorage`, `SnapshotObjectFormat`, `SnapshotObjectStorage`, `SnapshotObjectPublicationClaim`, `ProjectSnapshotCrud`, `ConflictDetector`, `RestorePolicy`, `ProjectRecovery` |
