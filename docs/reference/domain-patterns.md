...
| Versioning       | `Storyarn.Versioning`       | `EntityVersion`, `VersionCrud`, `SnapshotBuilder`, `SnapshotStorage`, `SnapshotObjectFormat`, `SnapshotObjectStorage`, `SnapshotObjectPublicationClaim`, `ProjectSnapshotCrud`, `ProjectSnapshotReconciliation`, `ConflictDetector`, `RestorePolicy`, `ProjectRecovery` |
...
finding schemas), and `SnapshotCleanupIntent`.
