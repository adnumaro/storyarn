defmodule Storyarn.Accounts.Authentication.Adapters.Email.Mailer do
  @moduledoc """
  Technical adapter that translates rendered Account content into Swoosh mail.

  Recipients, intent, copy, and localization are decided before this boundary.
  """
