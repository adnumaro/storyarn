defmodule Storyarn.Accounts.User do
  @moduledoc """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Storyarn.Repo)
  ...
  """
  def valid_password?(%Storyarn.Accounts.User{hashed_password: hashed_password}, password)
