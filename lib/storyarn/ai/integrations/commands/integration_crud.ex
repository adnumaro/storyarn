defmodule Storyarn.AI.IntegrationCrud do
  @moduledoc """
  Create, validate, rotate and revoke operations for
  ...
  @spec get_active(actor() | integer(), Provider.id() | String.t()) ::
          Integration.t() | nil
  ...
  """
  @spec connect(actor(), Provider.id() | String.t(), String.t()) ::
  ...
  remain untouched.
  """
  @spec replace_key(actor(), Integration.t(), String.t()) ::
  ...
  """
  @spec revalidate(actor(), Integration.t()) ::
          {:ok, Integration.t()} | {:error, credential_update_error()}
  ...
  actual transition.
  """
  @spec revoke(actor(), Integration.t()) ::
