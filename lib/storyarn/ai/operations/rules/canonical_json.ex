defmodule Storyarn.AI.Operations.Rules.CanonicalJSON do
  @moduledoc """
  Deterministic JSON encoding owned by durable AI operations.

  Operation payloads and results must preserve the established byte-level
  representation without coupling this capability to Platform or Routing.
  """
  ...
  defp encode_value(value) when is_map(value) do
    pairs = Enum.map(value, fn {key, item} -> {normalize_key(key), item} end)
