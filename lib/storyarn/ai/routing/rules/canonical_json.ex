defmodule Storyarn.AI.Routing.Rules.CanonicalJSON do
  @moduledoc """
  Deterministic JSON encoding owned by AI routing contracts.

  Routing hashes inputs before any operation exists, so it keeps its own
  encoder instead of importing a platform utility or another AI capability.
  """
