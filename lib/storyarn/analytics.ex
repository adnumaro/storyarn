defmodule Storyarn.Analytics do
  ...
  @event_property_keys %{
    ...
    "flow analysis run" => MapSet.new(~w(source finding_count dismissed_count error_count warning_count duration_bucket)),
    "flow analysis finding dismissed" => MapSet.new(~w(rule_id rule_version category severity reason_code)),
    "flow analysis finding restored" => MapSet.new(~w(rule_id reason_code)),
