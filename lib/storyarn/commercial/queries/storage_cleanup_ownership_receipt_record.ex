defmodule Storyarn.Commercial.Billing.Persistence.StorageCleanupOwnershipReceiptRecord do
  @moduledoc """
  Billing-owned read model for immutable cleanup handoff evidence.

  The cleanup pipeline in Projects writes the receipt. Commercial reads it to
