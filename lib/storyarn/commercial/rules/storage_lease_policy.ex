defmodule Storyarn.Commercial.Billing.StorageLeasePolicy do
  @moduledoc """
  Runtime policy for capacity reservations and snapshot storage leases.

  Commercial owns the reservation lifecycle. Projects consumes these values when
  it grants downloads or heartbeats snapshot publication, so both sides share
  one public policy without Commercial depending on Project internals.
  """
