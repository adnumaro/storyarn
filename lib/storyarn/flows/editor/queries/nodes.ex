defmodule Storyarn.Flows.Editor.Queries.Nodes do
  @moduledoc """
  Read side for authored Flow nodes and their reference projections.

  The module owns node lookup, catalog, and cross-flow reference resolution.
  It never mutates the Flow aggregate; commands consume these results through
  the Editor capability boundary.
  """
