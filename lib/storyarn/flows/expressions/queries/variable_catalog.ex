defmodule Storyarn.Flows.VariableCatalog do
  @moduledoc """
  Flow-owned read model for every variable addressable by conditions and
  instructions.

  It reads the shared persistence tables through records owned by Flows and
  emits the runtime descriptor shape consumed by the editor and evaluator.
  """

  import Ecto.Query

  alias Storyarn.Flows.Expressions.Projections.BlockRecord
  alias Storyarn.Flows.Expressions.Projections.ScenePinRecord
  alias Storyarn.Flows.Expressions.Projections.SceneRecord
  alias Storyarn.Flows.Expressions.Projections.SceneZoneRecord
  alias Storyarn.Flows.Expressions.Projections.SheetRecord
  alias Storyarn.Flows.Expressions.Projections.TableColumnRecord
  alias Storyarn.Flows.Expressions.Projections.TableRowRecord
