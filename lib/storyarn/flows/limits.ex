defmodule Storyarn.Flows.Limits do
  @moduledoc false
  ...
  @spec can_create_named_version?(pos_integer(), pos_integer()) ::
          :ok | {:error, :limit_reached | :project_scope_mismatch, map()}
  ...
  @doc false
  @spec ensure_named_version_capacity(pos_integer() | ProjectRecord.t()) ::
  ...
  @doc false
  @spec lock_named_version_project(pos_integer()) ::
          {:ok, ProjectRecord.t()}
  ...
  defp check_named_capacity(used, nil) do
    {:error, :limit_reached, %{resource: :named_versions_per_project, used: used, limit: 0}}
  end

  defp check_named_capacity(used, limit) when used < limit, do: :ok

  defp check_named_capacity(used, limit) do
    {:error, :limit_reached, %{resource: :named_versions_per_project, used: used, limit: limit}}
  end
end
