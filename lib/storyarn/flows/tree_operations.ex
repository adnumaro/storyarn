defmodule Storyarn.Flows.TreeOperations do
  ...
  # The table and columns are fixed Flow-owned identifiers; only values are
  # parameters. Keeping this as one update preserves the existing O(1) write
  # behavior without depending on the cross-tool tree utility.
  # sobelow_skip ["SQL.Query"]
  defp batch_set_positions(id_position_pairs, project_id, nil) do
