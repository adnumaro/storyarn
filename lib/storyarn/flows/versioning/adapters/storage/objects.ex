defmodule Storyarn.Flows.Versioning.Adapters.Storage.Objects do
  @moduledoc false
  ...
  def recoverable_blob_key?(key) when is_binary(key) do
  ...
  def recoverable_blob_key?(_key), do: false
