defmodule Storyarn.Flows.Versioning.EntityVersionRecord do
  @moduledoc """
  Flow-owned persistence record for the shared `entity_versions` table.

  Keeping this record inside the Flow bounded context lets Flow versioning
  ...
  def create_changeset(version, attrs) do
    ...
    |> validate_inclusion(:entity_type, ["flow"])
