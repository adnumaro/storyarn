defmodule Storyarn.Flows.Versioning.Entities.StorageCleanupRequestRecord do
  @moduledoc """
  Versioning-owned projection for durable cleanup requests created by Flow restore compensation.
  """
