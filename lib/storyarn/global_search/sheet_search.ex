defmodule Storyarn.GlobalSearch.SheetSearch do
  @moduledoc false

  import Ecto.Query

  alias Storyarn.GlobalSearch.Persistence.BlockGalleryImageRecord
  alias Storyarn.GlobalSearch.Persistence.BlockRecord
