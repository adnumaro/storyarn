defmodule Storyarn.Ideation.Decisions.Commands.Revise do
  @moduledoc false
  ...
  def run(scope, project_id, session_id, id, version, attrs) when valid_id(id) and valid_version(version) do
