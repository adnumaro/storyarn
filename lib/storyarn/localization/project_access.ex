defmodule Storyarn.Localization.ProjectAccess do
  ...
  alias Storyarn.Localization.Persistence.WorkspaceMembershipRecord
  ...
  @spec get_effective_membership(integer(), integer(), integer()) ::
          ProjectMembershipRecord.t() | nil
  def get_effective_membership(project_id, user_id, workspace_id)
  ...
  defp authorize_project(%ProjectRecord{} = project, user_id) do
    case get_effective_membership(project.id, user_id, project.workspace_id) do
