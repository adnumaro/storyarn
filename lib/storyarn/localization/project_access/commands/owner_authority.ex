defmodule Storyarn.Localization.ProjectAccess.Commands.OwnerAuthority do
  @moduledoc false
  ...
  @spec authorize_locked(map(), ProjectRecord.t()) ::
          :ok
          | {:error, :unauthorized | :ownership_invariant_violation | :authorization_transaction_required}
