defmodule Storyarn.Localization.ProjectAccess.Commands.ProjectReferenceIntegrity do
  @moduledoc false

  import Ecto.Query, warn: false

  alias Storyarn.Localization.ProjectAccess.Projections.AssetRecord
  alias Storyarn.Localization.ProjectAccess.Projections.ProjectRecord
  alias Storyarn.Localization.ProjectAccess.Projections.SheetRecord
  alias Storyarn.Repo
