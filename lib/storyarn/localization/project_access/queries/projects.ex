defmodule Storyarn.Localization.ProjectAccess.Queries.Projects do
  @moduledoc false
  ...
  alias Storyarn.Localization.ProjectAccess.Projections.WorkspaceRecord
  alias Storyarn.Localization.ProjectAccess.Queries.Memberships
  alias Storyarn.Repo
