defmodule Storyarn.Maps.Map do
  @moduledoc """
  Schema for maps.
  ...
  Maps are organized in a tree structure for drill-down navigation:
  ...
  @type t :: %__MODULE__{
          ...
          layers: [MapLayer.t()] | Ecto.Association.NotLoaded.t(),
          zones: [MapZone.t()] | Ecto.Association.NotLoaded.t(),
          pins: [MapPin.t()] | Ecto.Association.NotLoaded.t(),
          connections: [MapConnection.t()] | Ecto.Association.NotLoaded.t(),
          annotations: [MapAnnotation.t()] | Ecto.Association.NotLoaded.t(),
  ...
  schema "maps" do
    ...
    has_many :layers, MapLayer, preload_order: [asc: :position, asc: :id]
    has_many :zones, MapZone
    has_many :pins, MapPin
    has_many :connections, MapConnection
    has_many :annotations, MapAnnotation
