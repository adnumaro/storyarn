defmodule Storyarn.Platform.Billing.Persistence.SnapshotObjectPublicationClaimRecord do
  @moduledoc """
  Billing-owned projection of the publication fence for snapshot objects.

  Platform reads this proof before committing or releasing capacity. Projects
