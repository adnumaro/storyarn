defmodule Storyarn.Platform.Billing.Persistence.ProjectSnapshotRestoreRecord do
  @moduledoc """
  Billing-owned read model for the durable owner of a restore reservation.

  Restore lifecycle and mutation rules remain in Projects; Platform only locks
