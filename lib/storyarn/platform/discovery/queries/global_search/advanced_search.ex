defmodule Storyarn.Platform.GlobalSearch.AdvancedSearch do
  @moduledoc """
  ...
  alias Storyarn.Platform.GlobalSearch.Destinations
  alias Storyarn.Platform.GlobalSearch.FlowSearch
  alias Storyarn.Platform.GlobalSearch.Persistence.FlowRecord
  alias Storyarn.Platform.GlobalSearch.Persistence.SceneRecord
  alias Storyarn.Platform.GlobalSearch.Persistence.SheetRecord, as: Sheet
  alias Storyarn.Platform.GlobalSearch.SceneSearch
  alias Storyarn.Platform.GlobalSearch.SheetSearch
  alias Storyarn.Platform.GlobalSearch.VariableSearch
