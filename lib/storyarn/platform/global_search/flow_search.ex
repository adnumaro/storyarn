defmodule Storyarn.Platform.GlobalSearch.FlowSearch do
  @moduledoc false

  import Ecto.Query

  alias Storyarn.Platform.GlobalSearch.Persistence.FlowConnectionRecord
  alias Storyarn.Platform.GlobalSearch.Persistence.FlowNodeRecord
