defmodule Storyarn.Platform.Notifications.Notification do
  @moduledoc """
  ...
  defp validate_async_status(changeset) do
    ...
    cond do
      ...
      kind in (~w(content_created content_deleted comment_mention comment_reply comment_followed) ++ @decision_kinds) and
          not is_nil(status) ->
