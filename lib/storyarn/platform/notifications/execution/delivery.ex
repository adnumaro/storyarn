defmodule Storyarn.Platform.Notifications.Execution.Delivery do
  @moduledoc """
  ...
  def subscribe(%{user: %{id: user_id}}) do
    NotificationPubSub.subscribe(user_topic(user_id))
  end
  ...
  defp broadcast_users(user_ids) do
    ...
    |> Enum.each(fn user_id ->
      NotificationPubSub.broadcast(user_topic(user_id), :notifications_changed)
    end)
