defmodule Storyarn.Projects.FlowWordCount do
  @moduledoc """
  Computes Project import and reference-repair word counts for Flow node data.

  This copy keeps Project reconstitution and repair independent from the Flow
