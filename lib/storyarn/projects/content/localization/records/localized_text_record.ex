defmodule Storyarn.Projects.Persistence.LocalizedTextRecord do
  @moduledoc """
  Project-local writable record used only by derived-inventory maintenance and
  exact import/snapshot reconstitution. Ordinary translation writes remain in
  the Localization bounded context.
  """
