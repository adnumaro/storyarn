defmodule Storyarn.Projects.Exports.ExpressionTranspiler do
  @moduledoc """
  ...
  alias Storyarn.Projects.Exports.ExpressionTranspiler.Helpers
  ...
  @emitters %{
    ink: Storyarn.Projects.Exports.ExpressionTranspiler.Ink,
    yarn: Storyarn.Projects.Exports.ExpressionTranspiler.Yarn,
    unity: Storyarn.Projects.Exports.ExpressionTranspiler.Unity,
    godot: Storyarn.Projects.Exports.ExpressionTranspiler.Dialogic,
    unreal: Storyarn.Projects.Exports.ExpressionTranspiler.Unreal,
    articy: Storyarn.Projects.Exports.ExpressionTranspiler.Articy
  }
