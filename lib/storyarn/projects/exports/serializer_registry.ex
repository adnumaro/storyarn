defmodule Storyarn.Projects.Exports.SerializerRegistry do
  ...
  @serializers %{
    ink: Storyarn.Projects.Exports.Serializers.Ink,
    yarn: Storyarn.Projects.Exports.Serializers.Yarn,
    unity: Storyarn.Projects.Exports.Serializers.UnityJSON,
    godot: Storyarn.Projects.Exports.Serializers.GodotDialogic,
    unreal: Storyarn.Projects.Exports.Serializers.UnrealCSV,
    articy: Storyarn.Projects.Exports.Serializers.ArticyXML
  }
