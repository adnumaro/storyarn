defmodule Storyarn.Projects.SceneCondition do
  @moduledoc """
  Project-owned Scene condition interpretation used by Project consumers.

  A condition is stored as JSON on Scene elements.
  ...
  Max nesting: 1 level (groups cannot contain groups).
  ...
  Returns nil if parsing fails or the string is empty/invalid.
  """
  @spec parse(String.t() | nil) :: map() | nil
  ...
  def sanitize(_), do: %{"logic" => "all", "blocks" => []}
