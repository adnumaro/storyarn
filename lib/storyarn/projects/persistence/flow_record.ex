defmodule Storyarn.Projects.Persistence.FlowRecord do
  @moduledoc """
  Schema for flows.
  ...
  @type t :: %__MODULE__{
          ...
          nodes: [FlowNodeRecord.t()] | NotLoaded.t(),
          connections: [FlowConnectionRecord.t()] | NotLoaded.t(),
  ...
  schema "flows" do
    ...
    has_many :connections, FlowConnectionRecord, foreign_key: :flow_id
