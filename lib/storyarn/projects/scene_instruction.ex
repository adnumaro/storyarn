defmodule Storyarn.Projects.SceneInstruction do
  @moduledoc """
  Project-owned Scene assignment interpretation used by Project consumers.

  The write counterpart to Scene conditions.
  ...
  (`SceneVariableCatalog.list_referenceable/1`), and whatever a scene snapshot
