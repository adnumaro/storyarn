defmodule Storyarn.Projects.SheetHealthChecker do
  @moduledoc """
  ...
  defp block_identity_findings(sheet, block, snapshot) do
    variable? = can_be_variable?(field(block, :type)) and field(block, :is_constant, false) == false
  ...
  defp can_be_variable?(type), do: type not in @non_variable_types
end
