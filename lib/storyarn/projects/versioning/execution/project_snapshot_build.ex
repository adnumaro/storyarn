defmodule Storyarn.Projects.Versioning.ProjectSnapshotBuild do
  ...
  defp corrupt_source?(reason) do
    Enum.any?(
      [:snapshot_object_checksum_mismatch, :snapshot_object_size_mismatch, :snapshot_object_content_type_mismatch],
      &contains_reason?(reason, &1)
    )
  end
