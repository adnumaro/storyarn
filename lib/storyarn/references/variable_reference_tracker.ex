defmodule Storyarn.References.VariableReferenceTracker do
  @moduledoc """
  ...
  alias Storyarn.References.Persistence.SceneAmbientFlowRecord, as: SceneAmbientFlow
  alias Storyarn.References.Persistence.ScenePinRecord, as: ScenePin
  alias Storyarn.References.Persistence.SceneRecord, as: Scene
  alias Storyarn.References.Persistence.SceneZoneRecord, as: SceneZone
  alias Storyarn.References.Persistence.SheetRecord, as: Sheet
  alias Storyarn.References.Persistence.TableColumnRecord, as: TableColumn
  alias Storyarn.References.Persistence.TableRowRecord, as: TableRow
  alias Storyarn.References.VariableCatalog
