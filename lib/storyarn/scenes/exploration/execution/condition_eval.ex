defmodule Storyarn.Scenes.FlowRuntime.ConditionEval do
  @moduledoc """
  ...
  Parses the string first using the Scene Logic capability, then evaluates.
  """
  ...
  def evaluate_string(condition_string, variables) when is_binary(condition_string) do
    case Expressions.parse_condition(condition_string) do
      nil -> {true, []}
