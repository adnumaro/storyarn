defmodule Storyarn.Scenes.FlowRuntime.Engine do
  @moduledoc """
  ...
  alias Storyarn.Scenes.FlowRuntime.NodeEvaluators.ConditionNodeEvaluator
  alias Storyarn.Scenes.FlowRuntime.NodeEvaluators.DialogueEvaluator
  alias Storyarn.Scenes.FlowRuntime.NodeEvaluators.ExitEvaluator
  alias Storyarn.Scenes.FlowRuntime.NodeEvaluators.InstructionEvaluator
  alias Storyarn.Scenes.FlowRuntime.State
    ...
    %State{
      ...
      console: [
        %{
          ...
          node_id: nil,
          node_label: "",
          message: dgettext("scenes", "Debug session started"),
          rule_details: nil
        }
      ],
