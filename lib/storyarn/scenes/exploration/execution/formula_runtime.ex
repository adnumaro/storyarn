defmodule Storyarn.Scenes.FlowRuntime.FormulaRuntime do
  @moduledoc """
  Recomputes formula variables used by the Scenes exploration Flow runtime.

  This copy belongs to Scenes. Changes to the Flow editor or Sheet formula
  behavior must be adopted explicitly so they cannot silently change scene
