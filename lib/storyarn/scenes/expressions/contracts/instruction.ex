defmodule Storyarn.Scenes.Instruction do
  @moduledoc """
  Scene-owned assignment semantics for interactive elements.
  ...
  (`Storyarn.Scenes.Expressions.list_referenceable/1`), and whatever a scene snapshot
