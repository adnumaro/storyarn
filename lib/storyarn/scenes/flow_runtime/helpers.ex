defmodule Storyarn.Scenes.FlowRuntime.Helpers do
  @moduledoc """
  ...
  def strip_html(text, max_length), do: Storyarn.Platform.Shared.HtmlUtils.strip_and_truncate(text, max_length)
  ...
  def format_value(val) when is_binary(val) and byte_size(val) > 30, do: String.slice(val, 0, 30) <> "..."
