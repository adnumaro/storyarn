defmodule Storyarn.Scenes.ProjectAccess do
  @moduledoc false

  import Ecto.Query, warn: false

  alias Storyarn.Repo
  alias Storyarn.Scenes.Persistence.ProjectMembershipRecord
  alias Storyarn.Scenes.Persistence.ProjectRecord
  alias Storyarn.Scenes.Persistence.WorkspaceMembershipRecord
