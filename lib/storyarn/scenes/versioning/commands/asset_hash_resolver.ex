defmodule Storyarn.Scenes.Versioning.Commands.AssetHashResolver do
  @moduledoc """
  ...
  alias Storyarn.Scenes.Versioning.Rules.AssetPolicy
  ...
  defp create_from_portable_entry(project_id, user_id, entry, opts) do
    Assets.create_version_asset_from_storage(
      project_id,
      user_id,
      entry.blob_hash,
      entry.source_key,
