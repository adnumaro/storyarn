defmodule Storyarn.Scenes.Versioning.Entities.AssetRecord do
  @moduledoc "Versioning-owned persistence model used to capture and restore Scene assets without importing another context's schema."
