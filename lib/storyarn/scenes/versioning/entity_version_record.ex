defmodule Storyarn.Scenes.Versioning.EntityVersionRecord do
  @moduledoc """
  Scene-owned persistence record for the shared `entity_versions` table.

  Keeping this record inside the Scene bounded context lets Scene versioning
  ...
  def create_changeset(version, attrs) do
    ...
    |> validate_inclusion(:entity_type, ["scene"])
