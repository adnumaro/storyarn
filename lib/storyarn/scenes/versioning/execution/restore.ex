defmodule Storyarn.Scenes.Versioning.Execution.Restore do
  @moduledoc false
  ...
  alias Storyarn.Scenes.Versioning.Execution.Conflicts, as: ConflictDetector
  ...
  defp unsaved_since_latest_version?(%Scene{} = scene) do
    case History.get_latest_version(scene.id) do
      nil ->
        true
