defmodule Storyarn.Scenes.Versioning.Execution.SnapshotReader do
  @moduledoc false
  ...
  @doc false
  def get_builder!(@entity_type), do: SceneSnapshot

  def get_builder!(entity_type), do: raise(ArgumentError, "unknown Scene version entity type: #{inspect(entity_type)}")
