defmodule Storyarn.Sheets.AssetCommands do
  ...
  alias Storyarn.Sheets.Persistence.ProjectSnapshotRecord
  alias Storyarn.Sheets.Persistence.StorageReservationRecord
  alias Storyarn.Sheets.Persistence.UserRecord
  alias Storyarn.Sheets.Persistence.WorkspaceRecord
  alias Storyarn.Sheets.Persistence.WorkspaceSnapshotImportRecord
  alias Storyarn.Sheets.Versioning.AssetStorageCompensation
  ...
  defp delete_if_unchanged(storage_key, stat) do
    with {:ok, identity} <- storage_object_identity(storage_key, stat) do
      Storage.adapter().delete_if_matches(storage_key, identity)
    end
  end
