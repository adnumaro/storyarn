defmodule Storyarn.Sheets.Assets.Adapters.Projects.AssetRegistration do
  @moduledoc """
  Narrow Sheet adapter for Projects-owned asset-row commands.

  Sheet workflows retain upload, quota, storage and compensation concerns;
