defmodule Storyarn.Sheets.Assets.Commands.Assets do
  ...
  Sheets reads shared asset data through its local model and delegates asset
  row writes to narrow, transaction-bound Projects commands. Storage, quota,
  compensation and Sheet-owned events remain local to this workflow.
  """
  ...
  alias Storyarn.Sheets.Assets.Adapters.Projects.AssetRegistration, as: ProjectAssetRegistration
  ...
  alias Storyarn.Sheets.Assets.Projections.ProjectSnapshotRecord
  alias Storyarn.Sheets.Assets.Projections.StorageReservationRecord
  alias Storyarn.Sheets.Assets.Projections.UserRecord
