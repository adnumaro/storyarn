defmodule Storyarn.Sheets.Editor.Commands.Sheets do
  @moduledoc false
  ...
  defp descendant?(potential_descendant_id, ancestor_id) do
    TreeQueries.descendant?(potential_descendant_id, ancestor_id)
  end
  ...
  defp lock_and_normalize_sheet_references!(project_id, current_sheet, attrs) do
    ...
    case ReferenceTracker.lock_active_references(project_id, [
      ...
      {:ok, [normalized_parent_id, normalized_banner_asset_id]} ->
        ...
        case ReferenceTracker.ensure_locked_asset_content_type(
               project_id,
