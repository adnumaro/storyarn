defmodule Storyarn.Sheets.Logic do
  ...
  alias Storyarn.Sheets.Logic.Execution.FormulaResolver
  alias Storyarn.Sheets.Logic.Queries.FormulaBindings, as: FormulaBindingQueries
  alias Storyarn.Sheets.Logic.Queries.VariableCatalog
  alias Storyarn.Sheets.Logic.Queries.VariableNamespaces
  alias Storyarn.Sheets.Logic.Queries.VariableValues
  ...
  alias Storyarn.Sheets.Logic.Rules.FormulaBindings

  @doc "Ecto predicate for the authoritative owner of a Sheet variable namespace."
