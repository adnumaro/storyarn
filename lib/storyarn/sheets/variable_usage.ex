defmodule Storyarn.Sheets.VariableUsage do
  @moduledoc """
  ...
  alias Storyarn.Sheets.Persistence.SceneAmbientFlowRecord
  ...
  def check_stale_references(block_id, project_id) do
    SheetQueries.check_stale_flow_node_variable_references(block_id, project_id) ++
