defmodule Storyarn.Sheets.Versioning.Commands.NamedVersionCapacity do
  @moduledoc """
  Enforces the named-version entitlement for Sheet version writes.

  Project scope is read through Versioning's local projection; only Sheet
  version rows are counted and mutated by this capability.
  """
