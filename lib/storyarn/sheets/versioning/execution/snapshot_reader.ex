defmodule Storyarn.Sheets.Versioning.Execution.SnapshotReader do
  @moduledoc false
  ...
  @doc false
  def get_builder!(@entity_type), do: SheetSnapshot

  def get_builder!(entity_type), do: raise(ArgumentError, "unknown Sheet version entity type: #{inspect(entity_type)}")
