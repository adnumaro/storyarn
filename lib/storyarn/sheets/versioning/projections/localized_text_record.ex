defmodule Storyarn.Sheets.Versioning.Projections.LocalizedTextRecord do
  @moduledoc """
  Read-only Sheet versioning projection used for localization snapshot capture.

  Exact restore enters the Localization owner through the sealed version
  adapter; this mapping carries no write authority.
  """
