defmodule Storyarn.Versioning.Builders.FlowBuilder do
    ...
    Repo.transaction(fn ->
      ...
      flow_attrs =
        %{
          ...
          scene_id: resolve_flow_scene_id(snapshot["scene_id"], opts),
  ...
  defp resolve_flow_scene_id(_scene_id, opts) when not is_list(opts), do: nil

  defp resolve_flow_scene_id(scene_id, opts) do
    if MaterializationHelpers.preserve_external_refs?(opts) do
      DiffHelpers.resolve_fk(scene_id, Storyarn.Scenes.Scene)
    else
      nil
    end
  end
