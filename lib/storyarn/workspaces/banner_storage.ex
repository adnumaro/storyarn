defmodule Storyarn.Workspaces.BannerStorage do
  @moduledoc """
  Technical storage port used by the Workspace banner use case.

  Workspaces owns the banner lifecycle. The configured adapter only stores,
  deletes, and resolves opaque objects; it does not authorize users or decide
  which keys belong to a Workspace.
  """
