defmodule StoryarnWeb.Components.FocusLayoutV2 do
  @moduledoc """
  V2 Focus layout sub-components using LiveVue + shadcn-vue.

  Mirrors `FocusLayout` (v1) but replaces DaisyUI with Vue components.
