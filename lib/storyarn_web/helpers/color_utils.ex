defmodule StoryarnWeb.Helpers.ColorUtils do
  @moduledoc """
  Presentation-only color conversion for Storyarn's CSS theme tokens.

  Converts validated hexadecimal colors to OKLCH values consumed by the Web
  layer; no domain context depends on this module.
  """
