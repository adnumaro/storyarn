defmodule StoryarnWeb.FlowLive.Handlers.ResponseEventHandlers do
  ...
  @spec handle_add_response(map(), Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
  def handle_add_response(%{"node-id" => node_id}, socket) do
    ResponseHelpers.add_response(socket, node_id)
  end

  @spec handle_remove_response(map(), Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
  ...
  @spec handle_update_response_text(map(), Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
  ...
  @spec handle_update_response_condition(map(), Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
  ...
  @spec handle_update_response_instruction(map(), Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
