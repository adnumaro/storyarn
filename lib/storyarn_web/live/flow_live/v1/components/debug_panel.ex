defmodule StoryarnWeb.FlowLive.V1.Components.DebugPanel do
  @moduledoc """
  ...
  import StoryarnWeb.FlowLive.V1.Components.DebugConsoleTab
  import StoryarnWeb.FlowLive.V1.Components.DebugVariablesTab
  import StoryarnWeb.FlowLive.V1.Components.DebugHistoryTab

  alias Storyarn.Flows
  alias StoryarnWeb.FlowLive.V1.Components.DebugHistoryTab
