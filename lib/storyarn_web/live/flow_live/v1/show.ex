defmodule StoryarnWeb.FlowLive.V1.Show do
  @moduledoc false
  ...
  import StoryarnWeb.FlowLive.V1.Components.BuilderPanel
  import StoryarnWeb.FlowLive.V1.Components.DebugPanel
  import StoryarnWeb.FlowLive.V1.Components.FlowDock
  import StoryarnWeb.FlowLive.V1.Components.FlowHeader
  import StoryarnWeb.Components.CanvasToolbar
  import StoryarnWeb.Components.RightSidebar
  import StoryarnWeb.FlowLive.V1.Components.FlowToolbar
  import StoryarnWeb.Live.Shared.TreePanelHandlers

  alias StoryarnWeb.Components.Sidebar.FlowTree
  alias StoryarnWeb.FlowLive.V1.Components.ScreenplayEditor
  ...
  alias StoryarnWeb.FlowLive.V1.Handlers.CollaborationEventHandlers
  alias StoryarnWeb.FlowLive.V1.Handlers.DebugHandlers
  alias StoryarnWeb.FlowLive.V1.Handlers.EditorInfoHandlers
  alias StoryarnWeb.FlowLive.V1.Handlers.GenericNodeHandlers
  alias StoryarnWeb.FlowLive.V1.Handlers.NavigationHandlers
  alias StoryarnWeb.FlowLive.V1.Helpers.CollaborationHelpers
  alias StoryarnWeb.FlowLive.V1.Helpers.ConnectionHelpers
  alias StoryarnWeb.FlowLive.V1.Helpers.FormHelpers
  alias StoryarnWeb.FlowLive.V1.Helpers.NavigationHistory
  alias StoryarnWeb.FlowLive.V1.Helpers.NodeHelpers
  alias StoryarnWeb.FlowLive.V1.Helpers.SocketHelpers
  alias StoryarnWeb.FlowLive.V1.Helpers.VariableHelpers
  alias StoryarnWeb.FlowLive.V1.Nodes.Condition
  alias StoryarnWeb.FlowLive.V1.Nodes.Dialogue
  alias StoryarnWeb.FlowLive.V1.Nodes.Exit, as: ExitNode
  alias StoryarnWeb.FlowLive.V1.Nodes.Instruction
  alias StoryarnWeb.FlowLive.V1.Nodes.SlugLine
  alias StoryarnWeb.FlowLive.V1.Nodes.Subflow
  alias StoryarnWeb.FlowLive.V1.NodeTypeRegistry
  ...
  def render(assigns) do
    ...
    >
      ...
      <%!-- Preview Modal --%>
      <.live_component
        module={StoryarnWeb.FlowLive.V1.PreviewComponent}
        id="flow-preview"
        show={@preview_show}
  ...
  def handle_event("update_hub_color", %{"color" => color}, socket) do
    Authorize.with_authorization(socket, :edit_content, fn _socket ->
      validated =
        StoryarnWeb.FlowLive.V1.Components.NodeTypeHelpers.validate_hex_color(
          color,
