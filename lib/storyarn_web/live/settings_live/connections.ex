defmodule StoryarnWeb.SettingsLive.Connections do
  ...
  defp oauth_provider_row(assigns) do
    ~H"""
    <div class="flex items-center justify-between p-4 rounded-lg border border-base-300 bg-base-100">
  ...
  defp oauth_icon(assigns) do
    ~H"""
    <div class="size-10 flex items-center justify-center rounded-lg bg-base-200">
      <%= case @provider do %>
        <% "github" -> %>
