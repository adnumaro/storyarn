defmodule StoryarnWeb.SheetLive.Components.MapAppearancesSection do
  @moduledoc """
  ...
  def render(assigns) do
    ...
    <section>
      <h2 class="text-lg font-semibold mb-4 flex items-center gap-2">
        ...
        {dgettext("sheets", "Appears on Maps")}
  ...
  defp load_appearances(socket) do
    %{zones: zones, pins: pins} =
      Maps.get_elements_for_target("sheet", socket.assigns.sheet.id)
  ...
  defp appearance_row(assigns) do
    ...
    <.link
      navigate={
        ~p"/workspaces/#{@workspace.slug}/projects/#{@project.slug}/maps/#{@appearance.map_id}"
      }
    ...
    >
      ...
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2">
          <span class="font-medium truncate">{@appearance.map_name}</span>
        </div>
