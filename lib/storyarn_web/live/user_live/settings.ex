defmodule StoryarnWeb.UserLive.Settings do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope} workspaces={@workspaces}>
      <div class="text-center">
        <.header>
          ...
          <:subtitle>
            {gettext("Manage your account profile, email, password, and connected accounts")}
          </:subtitle>
        </.header>
      </div>
      ...
      <div class="space-y-8 max-w-lg mx-auto">
        <%!-- Profile Section --%>
        <section>
          <h3 class="text-lg font-semibold mb-4">{gettext("Profile")}</h3>
          <.form
            for={@profile_form}
            id="profile_form"
        ...
        <section>
          <h3 class="text-lg font-semibold mb-4">{gettext("Connected Accounts")}</h3>
          <p class="text-sm text-base-content/70 mb-4">
            {gettext("Link your social accounts for easier sign-in.")}
          </p>
          <div class="space-y-3">
            <.oauth_provider_row
              provider="github"
              ...
              has_password={!is_nil(@current_scope.user.hashed_password)}
  ...
  attr :identities_count, :integer, required: true
    ...
    <div class="flex items-center justify-between p-3 rounded-lg border border-base-300">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p :if={@identity} class="text-sm text-base-content/70">
        ...
        <%= if @identity do %>
          ...
          <% else %>
            <span
              ...
              title={gettext("Set a password before unlinking")}
            >
              {gettext("Connected")}
            </span>
          <% end %>
  ...
  defp oauth_icon(assigns) do
    ...
    <div class="size-8 flex items-center justify-center">
      <%= case @provider do %>
        ...
        <% "discord" -> %>
          <svg class="size-6" viewBox="0 0 24 24" fill="#5865F2">
  ...
  defp find_identity(identities, provider) do
