defmodule StoryarnWeb.VueTestLive do
  ...
  @variables [
    ...
    %{
      sheet_shortcut: "world-state",
      sheet_name: "World State",
    ...
    >
      ...
      <div class="max-w-2xl mx-auto space-y-10">
        ...
        <section class="space-y-2">
          ...
          <button
            phx-click="inc"
            class="mt-2 px-3 py-1.5 text-sm bg-primary text-primary-foreground rounded"
          >
