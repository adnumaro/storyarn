...
Software teams faced the same problem in another form. In 2011 Michael Nygard proposed [architecture decision records](https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions): short records with a status, proposed, accepted, and later superseded, kept next to the code because "large documents are never kept up to date." The decision lives where the work happens.
