...
El historial de Storyarn no nació de esta investigación, pero estas fuentes nos ayudan a medirlo. Versionamos unidades que el diseñador reconoce: Fichas, Flujos y Escenas. Sus revisiones pueden nombrarse y compararse mediante cambios estructurados, sin leer JSON. Cuando la restauración de entidades está habilitada, las rutas de Fichas, Flujos y Escenas persisten, vuelven a cargar y verifican el estado actual como versión de seguridad justo antes de cambiar nada. Las referencias obligatorias se validan contra destinos activos del mismo proyecto; las dependencias ausentes, mal formadas o ambiguas bloquean la restauración en vez de eliminarse silenciosamente.
...
También tenemos límites. La restauración de entidades se mantiene contenida de forma independiente para Fichas, Flujos y Escenas mientras cada ruta completa su verificación operativa, y la captura automática del historial no se activa de manera uniforme ante cualquier edición. Las capturas del proyecto no reproducen todavía un instante exacto: no recrean todo lo eliminado, no eliminan todo lo creado después ni incluyen cada área de la plataforma. No las presentamos como un rollback completo.
...
Las afirmaciones sobre Storyarn se revisaron contra su [implementación del historial](https://github.com/adnumaro/storyarn/blob/fedc69771168ae8732afd08013153659bb0efbfb/lib/storyarn/versioning/version_crud.ex), el [análisis de dependencias](https://github.com/adnumaro/storyarn/blob/fedc69771168ae8732afd08013153659bb0efbfb/lib/storyarn/versioning/conflict_detector.ex), las [capturas del proyecto](https://github.com/adnumaro/storyarn/blob/fedc69771168ae8732afd08013153659bb0efbfb/lib/storyarn/versioning/builders/project_snapshot_builder.ex) y sus pruebas.
