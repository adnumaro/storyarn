...
order: 3,
description: "Open Storyarn's control center with Meta+K (macOS) or Ctrl+K (Windows/Linux) to search and run commands anywhere."
}

---

The command palette is Storyarn's control center: one search box that finds and runs the commands available wherever you are — navigation, view controls, and workspace actions — without leaving the keyboard.
