...
Cada proyecto está completamente aislado, con sus propias hojas, flujos, escenas y guiones. Un espacio de trabajo puede contener tantos proyectos como necesites.
...
Después de crearlo, entrarás directamente al editor de hojas del proyecto.
