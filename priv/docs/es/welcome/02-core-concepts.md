...
| **Asset** | Un archivo multimedia subido, como una imagen o audio. Los assets pueden usarse en fichas, flujos, escenas, localización y exportaciones. | [Importar y Exportar](/docs/import-export/import-export-overview) |
...
| **Block** | Un campo tipado dentro de una ficha. Los bloques pueden guardar texto, texto enriquecido, números, booleanos, selecciones, fechas, tablas, referencias y más. | [Bloques](/docs/world-building/blocks) |
...
| **Zone** | Una región dibujada dentro de una escena. Las zonas pueden evaluar condiciones, ejecutar instrucciones, enlazar a flujos o abrir escenas hijas. | [Resumen de escenas](/docs/scene-design/scenes-overview) |
...
Las fichas definen el estado del mundo. Los bloques de las fichas se convierten en variables. Los flujos leen esas variables mediante nodos de condición y las modifican mediante nodos de instrucción. Las escenas colocan los flujos en un contexto espacial. Localización extrae el texto visible para el jugador. Importar y Exportar mueve el resultado a copias de seguridad o formatos específicos de engine.
