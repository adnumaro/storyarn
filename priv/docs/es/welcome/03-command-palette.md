...
order: 3,
description: "Abre el centro de control de Storyarn con Meta+K (macOS) o Ctrl+K (Windows/Linux) para buscar y ejecutar comandos desde cualquier lugar."
}

---

La paleta de comandos es el centro de control de Storyarn: un único buscador que encuentra y ejecuta los comandos disponibles allí donde estés — navegación, controles de vista y acciones de espacio de trabajo — sin soltar el teclado.
