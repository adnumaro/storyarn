defmodule Storyarn.Flows.HealthLabelParityTest do
  @moduledoc """
  Guards the Flow-owned health code-to-label contract without coupling it to
  ...
  test "the Flow health popover chrome exists in every locale" do
    for locale <- @locales do
  ...
  test "dashboard issue labels exactly cover Flow findings" do
    for locale <- @locales do
