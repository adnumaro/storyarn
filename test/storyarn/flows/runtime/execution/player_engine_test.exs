defmodule Storyarn.Flows.PlayerEngineTest do
  @moduledoc """
  ...
  test "public facade exposes the player runtime contract" do
    nodes = nodes_map([make_node(1, "entry"), make_node(2, "exit")])
    connections = [make_connection(1, 2)]

    assert {:finished, state, [{1, "entry"}]} =
             Flows.player_step_until_interactive(init_state(1), nodes, connections)
