  ...
  test "version two capsules remain restorable without a timer or contribution gate", ctx do
    ...
    legacy =
      ...
      |> update_in(
        ...
        &Map.drop(
          &1,
          ~w(timers groups group_memberships group_revisions references reference_revisions decisions decision_revisions decision_applications decision_task_links)
        )
      )
