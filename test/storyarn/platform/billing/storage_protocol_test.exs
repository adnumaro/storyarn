defmodule Storyarn.Platform.Billing.StorageProtocolTest do
  use ExUnit.Case, async: true

  alias Storyarn.Platform.Billing.Persistence.ProjectRecord
  alias Storyarn.Platform.Billing.Persistence.ProjectSnapshotRecord
  alias Storyarn.Platform.Billing.Persistence.SnapshotObjectPublicationClaimRecord
  alias Storyarn.Platform.Billing.Persistence.WorkspaceSnapshotImportRecord
  ...
  test "reservation associations stay inside the Platform persistence model" do
