defmodule Storyarn.Projects.Exports.SerializerRegistryTest do
  use ExUnit.Case, async: true

  alias Storyarn.Projects.Exports.SerializerRegistry
  alias Storyarn.Projects.Exports.Serializers.ArticyXML
  alias Storyarn.Projects.Exports.Serializers.GodotDialogic
  alias Storyarn.Projects.Exports.Serializers.Ink
  alias Storyarn.Projects.Exports.Serializers.UnityJSON
  alias Storyarn.Projects.Exports.Serializers.UnrealCSV
  alias Storyarn.Projects.Exports.Serializers.Yarn
