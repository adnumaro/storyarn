defmodule Storyarn.Projects.Versioning.ProjectSnapshotRestoreActorLockConcurrencyTest do
  ...
  defmodule EmptyMaterializer do
    ...
    alias Storyarn.Projects.Versioning.ProjectSnapshotAssetMaterializer.Plan
