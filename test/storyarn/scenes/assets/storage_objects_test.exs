defmodule Storyarn.Scenes.Assets.Adapters.Storage.ObjectsTest do
  use ExUnit.Case, async: false

  alias Storyarn.ConditionalCopyStorageSpy
  alias Storyarn.Scenes.Assets.Adapters.Storage.Objects
  ...
  test "accepts only the two Scenes-owned conditional-copy key shapes" do
  ...
  test "propagates a provider delete failure" do
    ...
    assert {:error, :delete_failed} = Objects.delete_owned_conditional_copy(@asset_copy_key)
    assert_receive {:conditional_copy_delete, @asset_copy_key}
  end
end
