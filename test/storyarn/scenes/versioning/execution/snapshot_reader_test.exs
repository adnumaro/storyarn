defmodule Storyarn.Scenes.Versioning.Execution.SnapshotReaderTest do
  ...
  defp version_record(project_id, scene_id, version_number) do
    %EntityVersionRecord{
      project_id: project_id,
      entity_id: scene_id,
      version_number: version_number,
      storage_key: SnapshotStorage.build_key(project_id, scene_id, version_number, "0123456789abcdef")
    }
  end
end
