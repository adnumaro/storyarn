defmodule Storyarn.Screenplays.ReverseNodeMappingTest do
  ...
  describe "node_to_element_attrs/1 — entry" do
    test "produces scene_heading with default content" do
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 10, type: "entry", data: %{}))
  ...
  describe "node_to_element_attrs/1 — scene" do
    test "reconstructs INT. heading with description and time" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 20, type: "scene", data: data))
    ...
    test "reconstructs EXT. heading" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 21, type: "scene", data: data))
    ...
    test "omits time suffix when time_of_day is empty" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 22, type: "scene", data: data))
    ...
    test "omits time suffix when time_of_day is nil" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 23, type: "scene", data: data))
  ...
  describe "node_to_element_attrs/1 — dialogue (action-style)" do
    test "empty text with stage_directions produces single action" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 30, type: "dialogue", data: data))

      assert [%{type: "action", content: "A desk sits in the corner.", source_node_id: 30}] =
               result
    end
  end
  ...
  describe "node_to_element_attrs/1 — dialogue (standard)" do
    test "produces character + dialogue (2 elements)" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 40, type: "dialogue", data: data))
    ...
    test "uses CHARACTER as default when menu_text is empty" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 41, type: "dialogue", data: data))

      assert [%{type: "character", content: "CHARACTER"}, %{type: "dialogue", content: "Hello."}] =
               result
    end
    ...
    test "with stage_directions produces character + parenthetical + dialogue (3 elements)" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 42, type: "dialogue", data: data))
  ...
  describe "node_to_element_attrs/1 — dialogue (with responses)" do
    test "produces character + dialogue + response" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 50, type: "dialogue", data: data))
    ...
    test "deserializes string condition via Condition.parse" do
      condition_json =
        Jason.encode!(%{
          "logic" => "all",
          "rules" => [
            %{"sheet" => "mc", "variable" => "hp", "operator" => "greater_than", "value" => "50"}
          ]
        })
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 51, type: "dialogue", data: data))
    ...
    test "deserializes string instruction via Jason.decode" do
      instruction_json =
        Jason.encode!([
          %{"sheet" => "mc", "variable" => "hp", "operator" => "set", "value" => "100"}
        ])
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 52, type: "dialogue", data: data))
    ...
    test "preserves linked_screenplay_id in response deserialization" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 54, type: "dialogue", data: data))
    ...
    test "passes through map condition and list instruction unchanged" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 53, type: "dialogue", data: data))
  ...
  describe "node_to_element_attrs/1 — dialogue (with speaker_sheet_id)" do
    test "propagates speaker_sheet_id as sheet_id in character data" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 58, type: "dialogue", data: data))
    ...
    test "sets character data to nil when speaker_sheet_id is nil" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 59, type: "dialogue", data: data))
    ...
    test "sets character data to nil when speaker_sheet_id is absent" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 60, type: "dialogue", data: data))
  ...
  describe "node_to_element_attrs/1 — dialogue (dual_dialogue)" do
    test "dialogue with dual_dialogue data produces dual_dialogue element" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 55, type: "dialogue", data: data))
    ...
    test "dialogue without dual_dialogue data produces standard elements" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 56, type: "dialogue", data: data))
    ...
    test "dual_dialogue with parentheticals populates parenthetical fields" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 57, type: "dialogue", data: data))
    ...
    test "produces conditional with condition data" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(
          build_node(id: 60, type: "condition", data: data)
        )

      assert [%{type: "conditional", data: %{"condition" => ^condition}, source_node_id: 60}] =
               result
    end

    test "defaults to empty condition when data is missing" do
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 61, type: "condition", data: %{}))

      assert [%{type: "conditional", data: %{"condition" => %{"logic" => "all", "rules" => []}}}] =
               result
    end
  end
  ...
  describe "node_to_element_attrs/1 — instruction" do
    test "produces instruction with assignments" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(
          build_node(id: 70, type: "instruction", data: data)
        )

      assert [%{type: "instruction", data: %{"assignments" => ^assignments}, source_node_id: 70}] =
               result
    end
  end
  ...
  describe "node_to_element_attrs/1 — exit" do
    test "produces transition with label" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 80, type: "exit", data: data))
    ...
    test "defaults to empty label" do
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 81, type: "exit", data: %{}))
  ...
  describe "node_to_element_attrs/1 — hub" do
    test "produces hub_marker preserving data" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 90, type: "hub", data: data))
  ...
  describe "node_to_element_attrs/1 — jump" do
    test "produces jump_marker preserving target_hub_id" do
      ...
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 100, type: "jump", data: data))

      assert [%{type: "jump_marker", data: %{"target_hub_id" => "hub-xyz"}, source_node_id: 100}] =
               result
    end
  end
  ...
  describe "node_to_element_attrs/1 — subflow" do
    test "returns empty list" do
      result =
        ReverseNodeMapping.node_to_element_attrs(build_node(id: 110, type: "subflow", data: %{}))
