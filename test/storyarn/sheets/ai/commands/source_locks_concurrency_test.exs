defmodule Storyarn.Sheets.AI.Commands.SourceLocksConcurrencyTest do
  ...
  alias StoryarnTest.Sheets.AI.ContextTask
  ...
  defp operation!(scope, project, sheet, block) do
    {:ok, subject_ref} =
      ContextContract.sheet(project.workspace_id, project.id, sheet.id, block_ids: [block.id])
