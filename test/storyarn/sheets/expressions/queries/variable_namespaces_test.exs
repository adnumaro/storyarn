defmodule Storyarn.Sheets.Expressions.Queries.VariableNamespacesTest do
  ...
  test "runtime and catalog surfaces expose only the authoritative numeric namespace owner" do
    ...
    assert Expressions.resolve_variable_values(project.id, [qualified_ref]) == %{
             qualified_ref => 20
           }
