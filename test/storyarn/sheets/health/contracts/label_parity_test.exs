defmodule Storyarn.Sheets.Health.Contracts.LabelParityTest do
  @moduledoc """
  Guards the Sheet-owned health code-to-label contract without coupling it to
  ...
  test "the Sheet health popover chrome exists in every locale" do
    for locale <- @locales do
  ...
  test "dashboard issue labels exactly cover Sheet findings" do
    for locale <- @locales do
