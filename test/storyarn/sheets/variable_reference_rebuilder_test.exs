defmodule Storyarn.Sheets.VariableReferenceRebuilderTest do
  ...
  test "rebuilds Flow and Scene references through Sheet-owned read models", ctx do
    ...
    assert :ok = VariableReferenceRebuilder.rebuild_project(ctx.project.id)
  ...
  test "rejects an invalid project scope" do
    assert {:error, {:invalid_project_id, nil}} =
             VariableReferenceRebuilder.rebuild_project(nil)
  end
