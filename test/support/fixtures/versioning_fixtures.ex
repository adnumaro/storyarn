defmodule Storyarn.VersioningFixtures do
  ...
  def full_project_snapshot_fixture(project, attrs \\ %{}) do
    ...
    archive_size = Map.get(attrs, :archive_size_bytes, project_size + asset_blob_size)
    total_size = archive_size + manifest_size
  ...
  defp ready_prefix(project_id) do
    ...
    SnapshotArchiveStorage.ready_prefix(project_id, token)
  end
end
